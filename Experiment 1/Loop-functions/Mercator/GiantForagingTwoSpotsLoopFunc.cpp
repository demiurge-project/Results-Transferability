/**
 * @file <GiantForagingTwoSpotsLoopFunc.cpp>
 *
...
#include "GiantForagingTwoSpotsLoopFunc.h"

/****************************************/
/****************************************/

GiantForagingTwoSpotsLoopFunction::GiantForagingTwoSpotsLoopFunction()
{
  m_fRadius = 0.58;
  m_fNestLimit = -2.35;
  m_cCoordSpot1 = CVector2(2.9, 0);
  m_cCoordSpot2 = CVector2(-2.9, 0);
...
GiantForagingTwoSpotsLoopFunction::GiantForagingTwoSpotsLoopFunction(const GiantForagingTwoSpotsLoopFunction &orig)
{
}
...
void GiantForagingTwoSpotsLoopFunction::Init(TConfigurationNode &t_tree)
{
...
void GiantForagingTwoSpotsLoopFunction::Destroy() {}

/****************************************/
/****************************************/

argos::CColor GiantForagingTwoSpotsLoopFunction::GetFloorColor(const argos::CVector2 &c_position_on_plane)
{
  ...
  {
    Real fMaxDim = 4.7957;
    Real fLengthWall = 2.57;
    Real fWidthWall = 0.01;
    Real fPI = 3.14159265;
    CVector2 cCenter(0, m_fNestLimit);
    CVector2 cTop(4.1562 + fWidthWall, m_fNestLimit);
    CVector2 cBottom(-4.1562 - fWidthWall, m_fNestLimit);
    CVector2 cAngle1(4.1562 - ARGOS_COS(60 * fPI / 180.0f) * fLengthWall / 2 + fWidthWall, m_fNestLimit - (ARGOS_SIN(60 * fPI / 180.0f) * fLengthWall / 2) - fWidthWall);
    CVector2 cAngle2(fLengthWall / 2 + fWidthWall, -fMaxDim);
    CVector2 cAngle3(-(fLengthWall / 2 + fWidthWall), -fMaxDim);
    CVector2 cAngle4(-4.1562 + ARGOS_COS(60 * fPI / 180.0f) * fLengthWall / 2 - fWidthWall, m_fNestLimit - (ARGOS_SIN(60 * fPI / 180.0f) * fLengthWall / 2) - fWidthWall);
...
Real GiantForagingTwoSpotsLoopFunction::AreaTriangle(CVector2 &c_point_a, CVector2 &c_point_b, CVector2 &c_point_c)
{
...
bool GiantForagingTwoSpotsLoopFunction::IsWithinTriangle(CVector2 &c_point_q, CVector2 &c_point_a, CVector2 &c_point_b, CVector2 &c_point_c)
{
...
void GiantForagingTwoSpotsLoopFunction::Reset()
{
...
void GiantForagingTwoSpotsLoopFunction::PostStep()
{
...
Real GiantForagingTwoSpotsLoopFunction::GetObjectiveFunction()
{
  if (m_bMinimizeScore) {
...
CVector3 GiantForagingTwoSpotsLoopFunction::GetRandomPosition()
{
  Real temp;
...
void GiantForagingTwoSpotsLoopFunction::PostExperiment()
{
  if (m_bOutputInFile)
  {
...
REGISTER_LOOP_FUNCTIONS(GiantForagingTwoSpotsLoopFunction, "giant_foraging_loop_functions");
